...
import { OpenNodeError } from "opennode/src/OpenNodeError";
import { OpenNodeEnv } from "opennode/src/types";
import {
  OpenNodeBalance,
  OpenNodeCharge,
...
} from "opennode/src/types/v1";
import * as v2 from "opennode/src/types/v2";

const version = require("opennode/package.json")?.version || "local";
